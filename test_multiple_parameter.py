...
def plot_score_comparision():
    ...
    for month in months:
        ...
        # temp comparision 
        ax.plot(ind, temp_score[:, 0, 0], label='Mean Squared Distance')
        ax.plot(ind, temp_score[:, 0, 1], label='STD (Squared Distance)')
        ax.plot(ind, temp_score[:, 0, 2], label='Mean Absolute Distance')
        ax.plot(ind, temp_score[:, 0, 3], label='STD (Absolute Distance)')
        ax.plot(ind, temp_score[:, 0, 4], label='RMSE')
